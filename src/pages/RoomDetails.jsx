  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
        ...
        <p className='text-xs font-inter py-1.5 px-3 text-white bg-orange-500 rounded-full'>20% de descuento</p>
      </div>
    ...
    <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
            <h1 className='text-3xl md:text-4xl font-playfair'>Experiencia en lujosidad</h1>
     ...
     <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
            <div className='flex flex-col'>
                <label htmlFor="guests" className='font-medium'>Invitados</label>
...
>
  Disponibilidad
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Los huéspedes serán asignados en la planta baja según la disponibilidad. Obtendrás un cómodo apartamento de dos habitaciones con un auténtico ambiente urbano. El precio indicado es para dos personas; en el apartado de huéspedes, marca el número de personas para obtener el precio exacto para grupos. Los huéspedes serán ubicados en la planta baja según la disponibilidad. Disfrutarás de un cómodo apartamento de dos habitaciones con una verdadera sensación de ciudad.</p>
    </div>
    ...
    <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
            ...
            <div>
                <p className='text-lg md:text-xl'>Huesped por {room.hotel.name}</p>
